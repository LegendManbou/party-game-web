...
- skribbl.io への外部リンクを追加しています。
- 一致するまで終われまテンへの外部リンクを追加しています。
- 外部ゲームのカード画像は公式ロゴやスクリーンショットを使わず、`assets/games/` 配下の自作SVGを使います。
- このサイトは個人制作の非公式サイトです。外部ゲームへのリンクは各公式サイトを新しいタブで開きます。
